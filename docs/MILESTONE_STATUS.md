...
- War Factory production now includes imported Bastion light, medium, and heavy tank silhouettes. The medium tank can board one rifleman passenger, saves/restores that passenger count, and fires an extra passenger weapon while attacking.
...
- EditMode tests: `99` total, `99` passed, `0` failed.
