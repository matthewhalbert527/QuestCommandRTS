...
- User pause blocks gameplay commands but keeps system UI available for resume/save/load/new match.
- New Match clears dirty or restored skirmish state without scene reload, resets user and match-ended pause reasons, and rebuilds starting resources, units, structures, fog, selection, and enemy AI economy.
