...
namespace BastionWarFactoryCMV2.Editor
{
    public static class BastionWarFactoryCMV2PrefabBuilder
    {
        ...
        public static void BuildPrefab(bool selectPrefab)
        {
            ...
            var metadata = root.AddComponent<BastionWarFactoryCMV2>();
            ...
            var active = root.AddComponent<BastionWarFactoryActiveAnimator>();
            ...
            var teamColor = root.AddComponent<BastionTeamColor>();
        ...
        private static Material CreateBaseMaterial()
        {
            ...
            mat.SetColor("_BaseColor", new Color(0.58f, 0.62f, 0.46f));
            mat.SetColor("_Color", new Color(0.58f, 0.62f, 0.46f));
